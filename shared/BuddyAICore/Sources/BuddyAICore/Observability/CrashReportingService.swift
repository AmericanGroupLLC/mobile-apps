...
/// `NoopCrashReportingService`; v1.1 will optionally attach Sentry
/// behind a Settings opt-in.
///
/// IMPORTANT: Offline AI Buddy v1 does NOT send any crash reports.
/// This file declares the interface only.
