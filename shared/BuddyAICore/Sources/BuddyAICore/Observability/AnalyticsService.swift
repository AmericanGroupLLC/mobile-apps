...
/// Telemetry slot. v1 attaches `NoopAnalyticsService`; v1.1 will
/// optionally attach a real PostHog/Mixpanel transport behind a
/// Settings opt-in.
///
/// IMPORTANT: Offline AI Buddy v1 does NOT send any telemetry. This
/// file declares the interface only — no SDK is imported, no transport
/// is wired.
